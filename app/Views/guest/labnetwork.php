                    ...
                    <div class="col-12">
                        ...
                        <div class="card rounded-3  mt-5">
                            ...
                            <div class="card-body">
                                <!-- project number -->
                                <div>
                                    <img src="assets/img/Labo-3.png" alt="" class="mb-3" style="width: 100%; height: auto; border-radius: 10px ;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <ul class="fa-ul">
                                                <li><span class="fa-li" style="width: 32px; height: 32px"><i class="fa-regular fa-circle-dot"></i></span>Hub</li>
                                                <li><span class="fa-li" style="width: 32px; height: 32px"><i class="fa-regular fa-circle-dot"></i></span>Cable VGA, HDMI, LAN </li>
                                                <li><span class="fa-li" style="width: 32px; height: 32px"><i class="fa-regular fa-circle-dot"></i></span>Switch</li>
                                                <li><span class="fa-li" style="width: 32px; height: 32px"><i class="fa-regular fa-circle-dot"></i></span>TP Link</li>
                                            </ul>
                                        </div>
                                        <div class="col-4">
                                            <ul class="fa-ul">

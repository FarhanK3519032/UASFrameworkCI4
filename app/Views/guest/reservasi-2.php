                        ...
                        <div class="card rounded-3">
                            ...
                            <div class="card-body text-left">
                                <form action="">
                                    ...
                                    <div class="mb-3">
                                        <label for="nipm" class="form-label">NIP/NIM</label>
                                        <input type="text" class="form-control" id="nipm">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <span>
                                            <a href="/reservasi" class="txt33" style="text-decoration: none; color: #00A2E9;"><i class="fa-solid fa-arrow-left-long" style="color: #00A2E9; padding-right: 10px;"></i>Form for Non-Civitas UNS</a>
                                        </span>
                                    </div>
                                </form>
                            </div>

                    ...
                    <div class="col-12">
                        ...
                        <div class="card rounded-3  mt-5">
                            ...
                            <div class="card-body">
                                <!-- project number -->
                                <div>
                                    <img src="assets/img/Labo-2.png" alt="" class="mb-3" style="width: 100%; height: auto; border-radius: 10px ;">
                                    <p class="mt-0">Laboratorium software engineering merupakan studio yang dikhususkan untuk kegiatan yang berhubungan dengan multimedia (shooting, editing, designing, dll). Pada lab ini disediakan berbagai macam fasilitas penunjang kegiatan pembelajaran maupun diskusi. berbagai macam fasilitas yang disediakan yaitu :</p>
                                    <div class="row">
                                        <div class="col-4">
                                            <ul class="fa-ul">
                                        ...
                                        <div class="col-4">
                                            <ul class="fa-ul">
                                                <li><span class="fa-li" style="width: 32px; height: 32px"><i class="fa-regular fa-circle-dot"></i></span>Camera</li>
                                                <li><span class="fa-li" style="width: 32px; height: 32px"><i class="fa-regular fa-circle-dot"></i></span>Microphone</li>
                                                <li><span class="fa-li" style="width: 32px; height: 32px"><i class="fa-regular fa-circle-dot"></i></span>Foto Light</li>
                                                <li><span class="fa-li" style="width: 32px; height: 32px"><i class="fa-regular fa-circle-dot"></i></span>Background Curtain</li>
                                            </ul>
                                        </div>
                                        <div class="col-4">
                                            <ul class="fa-ul">
                                                <li><span class="fa-li" style="width: 32px; height: 32px"><i class="fa-regular fa-circle-dot"></i></span>Speaker</li>
                                                ...
                                                <li><span class="fa-li" style="width: 32px; height: 32px"><i class="fa-regular fa-circle-dot"></i></span>etc</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
